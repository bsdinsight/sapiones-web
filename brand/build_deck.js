...
pill(s,0.94,5.25,5.5,0.55,"✓  Miễn phí tới 20 nhân viên — không giới hạn thời gian",WHITE,GREEN);
...
const vals=[
 ...
 ["Mở & on-premise","Mã nguồn mở phần lõi, chủ quyền dữ liệu, miễn phí tới 20 nhân viên."],
];
...
/* ---------- S5 Professional ---------- */
s = pres.addSlide(); s.background={color:WHITE};
title(s,"PROFESSIONAL — Vận hành & Tuân thủ","Cho doanh nghiệp > 20 nhân viên");
const pro=[
...
/* ---------- S8 Pricing ---------- */
s = pres.addSlide(); s.background={color:WHITE};
title(s,"Mô hình mở — Miễn phí tới 20 nhân viên","Dùng đủ tính năng bằng dữ liệu thật; nâng cấp theo số lao động khi lớn lên.");
const tiers=[
 ["Miễn phí","≤ 20 nhân viên",GREEN,["Đủ mọi tính năng để dùng thử","Mã nguồn mở phần lõi","Dùng bằng dữ liệu thật","On-premise hoặc cloud"]],
 ["Professional","Doanh nghiệp > 20 NV",INDIGO,["Trọn bộ tính năng nghiệp vụ","Lương + phiếu lương + file NH","Ca kíp, máy chấm công, lương SP","Kê khai điện tử + Cổng NV"]],
