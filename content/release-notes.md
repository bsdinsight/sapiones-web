...
- **Tạo nhân viên từ ứng viên trúng tuyển** — prefill hồ sơ VN (CCCD), liên kết về phiếu ứng viên; tuân theo bản quyền (miễn phí tới 20 NV).
...
- **Mô hình mở** — miễn phí tới **20 nhân viên**, không giới hạn thời gian.
...
- Khung bản quyền: **miễn phí tới 20 nhân viên**; vượt → bản quyền theo số lao động; **khóa mềm giữ nguyên dữ liệu**.
